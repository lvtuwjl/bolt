Bolt [![Coverage Status](https://coveralls.io/repos/boltdb/bolt/badge.svg?branch=master)](https://coveralls.io/r/boltdb/bolt?branch=master) [![GoDoc](https://godoc.org/github.com/lvtuwjl/bolt?status.svg)](https://godoc.org/github.com/lvtuwjl/bolt) ![Version](https://img.shields.io/badge/version-1.2.1-green.svg)
====
...
```sh
$ go get github.com/lvtuwjl/bolt/...
```
...
system's page cache. See the [`Tx`](https://godoc.org/github.com/lvtuwjl/bolt#Tx)
...
[page-allocation]: https://github.com/lvtuwjl/bolt/issues/308#issuecomment-74811638
